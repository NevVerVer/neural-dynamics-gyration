...
def preprocess(datas,
        ...
        if extra:
            return datas, data_list, full_data_var, pca_variance_captured, pca
        else:
...
red_green_cmap = lambda : matplotlib.colors.LinearSegmentedColormap.from_list("", ['#06b00d',
                                                                                    '#0bea0c',
                                                                                    '#de0001',
                                                                                    '#9c0a0b'])
...
#     colormap = plt.cm.rainbow
    # if custom_color_vector:
    #     colors = np.array([colormap(i) for i in custom_color_vector])
    # else:
